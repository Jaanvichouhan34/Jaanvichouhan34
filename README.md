 ...
 * @param {string}  hobbies        - Sketching, sports, outdoor activities
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <code>React</code> <code>Node.js</code> <code>MongoDB</code> <code>Groq API</code> <code>PDF Gen</code>
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <code>React</code> <code>Tailwind</code> <code>Framer Motion</code> <code>Groq API</code>
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Personal growth platform with an <b>Outfit Scanner</b>, Event Prep Guide, and Communication Skills Trainer. Fully documented with UML diagrams.</p>
      <code>React</code> <code>Groq API</code> <code>Node.js</code> <code>MongoDB</code>
    </td>
    <td width="50%" valign="top">
      <h4>🚚 QuickDrop — Hyperlocal Delivery Platform</h4>
      <p>Hyperlocal delivery platform with three user panels (customer, delivery partner, admin) and integrated Razorpay payments.</p>
      <code>MERN Stack</code> <code>Razorpay</code> <code>React</code>
    </td>
  </tr>
</table>
...
- 🏆 **Smart India Hackathon** — Internal round clearance (2nd & 3rd year)
...
- 🤖 **IBM SkillsBuild AICTE Internship** — AI & Cloud Technologies (100% completion, 7/7 courses)
...
<div align="center">
  ...
  <a href="https://nova-six-chi.vercel.app/">
